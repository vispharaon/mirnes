    ...
    function AuthenticationService($http, $cookieStore, $rootScope, $timeout, UserService) {
        ...
        function Login(username, password, callback) {
           ...
           /* $http.post('http://cabapis.azurewebsites.net/api/user', { username: username, password: password })
            ...
            $http({ method: 'GET', dataType: 'jsonp', url: 'http://cabapis.azurewebsites.net/api/korisnici', params: { username: username, password: password }}).
        ...
        function ClearCredentials() {
            console.log("clearingcredentials");
            $rootScope.globals = {};
